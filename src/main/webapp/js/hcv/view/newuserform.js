/*global Ext */
Ext.define('hcv.view.NewUserForm',
{
	...
	initComponent:function()
	{
		var config=
		{
			...
			[
				{
					...
					//rvOptions: {url: utils.webapp()+'/ajax/validate/user.json'}
				},
				{
					fieldLabel:'Password*',
					name: 'password1',
			...
			initialConfig:
			{
				api:
				{
					load: hcvDirect.getNewUserForm,
					submit: hcvDirect.postNewUserForm
				}
			}
		};
		
		Ext.apply(this, Ext.apply(this.initialConfig, config));
		hcv.view.NewUserForm.superclass.initComponent.apply(this, arguments);
	},
	
	onRender:function()
	{
		hcv.view.NewUserForm.superclass.onRender.apply(this, arguments);
