...
Ext.define('hcv.view.Comments',
{
	...
	initComponent:function()
	{
		...
		var store = new Ext.data.DirectStore( {
			...
			totalProperty: 'total',
			remoteSort: true,
			directFn: hcvDirect.loadComments,
		...
		*/
		...
		hcv.view.Comments.superclass.initComponent.apply(this, arguments);
	...
	{
		var self=this;
		var win=new hcv.view.CommentWindow(
		{
			type: self.type,
