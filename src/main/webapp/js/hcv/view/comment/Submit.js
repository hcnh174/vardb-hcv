/*global Ext */
Ext.define('hcv.view.CommentWindow',
{
	...
	initComponent:function()
	{
		...
		var form=new Ext.form.FormPanel(
		{
			...
			[
				{
					id: 'hcv-comment-window-clear-btn',
					text: 'Clear',
					formBind: true,
					scope: this,
				...
				{
					id: 'hcv-comment-window-submit-btn',
					text: 'Submit',
					formBind: true,
					scope: this,
		...
		hcv.view.CommentWindow.superclass.initComponent.apply(this, arguments);
		this.form=form;
		this.show();
	},
	...
	submitComment:function()
	{
		...
		hcvDirect.submitComment(this.type, this.identifier, value, function(result, evt)
		{
			if (self.callback)
				{self.callback();}
			self.close();
